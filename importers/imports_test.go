...
func TestMergeSet(t *testing.T) {
	...
	a := Set{
		Standard:   List{"fmt"},
		ThirdParty: List{"github.com/JoshuaWilkes/sqlboiler-pgx", "github.com/volatiletech/null/v8"},
	}
	b := Set{
		Standard:   List{"os"},
		ThirdParty: List{"github.com/JoshuaWilkes/sqlboiler-pgx"},
	}
	...
	if c.ThirdParty[0] != "github.com/volatiletech/null/v8" && c.ThirdParty[1] != "github.com/JoshuaWilkes/sqlboiler-pgx" {
